/****************************************************************************
** Meta object code from reading C++ file 'q_player.h'
**
...
#error "The header file 'q_player.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(10, 125, 10), // "get_winner"
...
void q_player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->get_winner((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&q_player::select_piece)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&q_player::turn_complete)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject q_player::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_q_player.data,
      qt_meta_data_q_player,  qt_static_metacall, nullptr, nullptr}
};
